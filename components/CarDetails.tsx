              ...
              <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5 p-6'>
                ...
                <div className='flex-1 flex flex-col gap-3'>
                  <div className='relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg'>
                    {/* Optimization: Removed 'priority' prop from modal images so they default to lazy-loading.
                        This prevents eager fetching of hidden modal images, improving overall page load performance and LCP. */}
                    <Image src={generateCarImageUrl(car)} alt='car model' fill className='object-contain' sizes='(max-width: 640px) 100vw, 512px' />
                  </div>
